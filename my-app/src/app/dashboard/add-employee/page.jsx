  ...
  return (
    <div>
        <div className='flex gap-5 justify-center items-center'>
            <input type="text" placeholder='Enter name of employee' className='px-2 py-2 text-center rounded-md mt-4' required  />
            <input type="text" placeholder='Enter Designation' className='px-2 py-2 text-center rounded-md mt-4' required  />
            <input type="text" placeholder='Give Description' className='px-2 py-2 text-center rounded-md mt-4' required  />
