          ...
          {!showChangePassword ? (
            <>
              <div className="relative  flex items-center justify-center">
                {isLoading ? (
                  <div className="absolute top-1/2 inset-0 flex flex-col items-center justify-center  bg-transparent bg-opacity-50">
                    <div
                      role="status"
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label htmlFor="oldPassword" className="block text-white">
                    Old Password
                  </label>
                  <input
                    type="password"
                ...
                <button
                  type="submit"
                  className="w-32 bg-blue-500 text-white p-2 rounded mt-4 mr-4"
                >
                  Update
                </button>
                <button
